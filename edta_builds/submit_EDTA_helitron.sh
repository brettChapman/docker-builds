...
## Usage: sbatch submit_EDTA_helitron.sh genome.fna
...
srun -n 1 singularity exec --bind ${PWD}:${PWD} ${EDTA_IMAGE} EDTA_raw.pl --threads ${SLURM_NTASKS_PER_NODE} --genome ${GENOME} --type helitron
